                  ...
                  <div className="banner-info">
                    <div className="container">
                      <div className="banner-info-bg mr-auto">
                        ...
                        <Link className="btn btn-secondary btn-theme2 mt-md-5 mt-4" to="/services">
                          {" "}
                          Our Services
                        </Link>
                      </div>
                  ...
                  <div className="banner-info">
                    <div className="container">
                      <div className="banner-info-bg mr-auto">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, velit recusandae eum necessitatibus blanditiis porro cum</p>
                        <Link className="btn btn-secondary btn-theme2 mt-md-5 mt-4" to="/contact">
                          {" "}
                          Contact Us
                        </Link>
                      </div>
                  ...
                  <div className="banner-info">
                    <div className="container">
                      <div className="banner-info-bg mr-auto">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, velit recusandae eum necessitatibus blanditiis porro cum</p>
                        <Link className="btn btn-secondary btn-theme2 mt-md-5 mt-4" to="/about">
                          {" "}
                          About Us
                        </Link>
                      </div>
                  ...
                  <div className="banner-info">
                    <div className="container">
                      <div className="banner-info-bg mr-auto">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, velit recusandae eum necessitatibus blanditiis porro cum</p>
                        <Link className="btn btn-secondary btn-theme2 mt-md-5 mt-4" to="/servces">
                          Read More
                        </Link>
                      </div>
                    </div>
